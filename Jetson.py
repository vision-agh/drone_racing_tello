    ...
    def getPositions(self):
        ...
        if ids is not None:
            ...
            for corner in corners:
                rvec1, tvec1 = cv2.aruco.estimatePoseSingleMarkers(corner, self.ArUcoSize, DronVision.mtx, DronVision.dist)
                if len(rvec1) == 1:
...
FlightStrategy = 2    # 1 - First flight strategy, 2 - second flight strategy
